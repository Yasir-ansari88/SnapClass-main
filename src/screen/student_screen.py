...
def student_dashboard():
    ...
    for i, sub_node in enumerate(subjects):
        ...
        def unenroll_button():
            if st.button("Unenroll from this coures", type = 'tertiary', width= 'stretch', icon= ':material/delete_forever:', key = f'unenroll_{sid}'):
...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter Your Name", placeholder='E.g. Mohd Yasir')
            ...
            try:
                audio_data = st.audio_input("Record a short phrase like I am presnet, My name is xyz")
            except Exception:
